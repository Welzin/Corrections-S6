...
void key (unsigned char keyPressed, int x, int y) {
    ...
    case 'w':
        ...
        break;
    case 'A':
        ambientRef = min(ambientRef + 0.1, 2.);
        cout << "Ambient : " << ambientRef << endl;
        break;
    case 'a':
        ambientRef = max(ambientRef - 0.1, 0.);
        cout << "Ambient : " << ambientRef << endl;
        break;
    case 'D':
        diffuseRef = min(diffuseRef + 0.1, 2.);
        cout << "Diffuse : " << diffuseRef << endl;
        break;
    case 'd':
        diffuseRef = max(diffuseRef - 0.1, 0.);
        cout << "Diffuse : " << diffuseRef << endl;
        break;
    case 'S':
        specularRef = min(specularRef + 0.1, 2.);
        cout << "Speculaire : " << specularRef << endl;
        break;
    case 's':
        specularRef = max(specularRef - 0.1, 0.);
        cout << "Speculaire : " << specularRef << endl;
        break;
    case '+':
        shininess = min(shininess + 1., 30.);
        cout << "Shineness : " << shininess << endl;
        break;
    case '-':
